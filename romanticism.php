        ...
        <footer>
            ...
            <div class="contacts">
                ...
                <div class="contactsGroup">
                    ...
                    <div class="contactsLine">
                        <img src="img/mail.png" style="width: 20px; height: 20px;" alt="">
                        <a href="mailto:musa.find@gmail.com" style="margin-top: 25px;">musa.find@gmail.com</a>
                    </div>
                </div>
                <div class="contactsGroup">
                    <h4>Співпраця</h4>
                    <div class="contactsLine">
                        <img src="img/mail.png" style="width: 20px; height: 20px;" alt="">
                        <a href="mailto:team_musa.find@gmail.com" style="margin-top: 25px;">team_musa.find@gmail.com</a>
                    </div>
                </div>
            </div>
        </footer>
